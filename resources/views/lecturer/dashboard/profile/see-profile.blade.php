                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Lecturer Profile</a></li>
                            </ol>
                        </div>
...
{{--                Start Row       --}}
            <div class="row">
                <div class="col-md-8 offset-2">
                    <form action="{{ route('lecturer.profile.update',['id'=> $profile->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    <label class="form-control" for="">Position</label>
                                </div>
                                <div class=" col-md-9">
                                    <input class="form-control" name="position" readonly value="{{ $profile->position }}"/>
                                </div>
                            </div>
