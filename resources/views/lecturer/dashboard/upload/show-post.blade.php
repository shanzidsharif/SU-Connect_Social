                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="" class="btn-outline-primary btn mt-2 mx-2">like</a>
                            <a href="" class="btn btn-outline-light mt-2 mx-2">Comment</a>
                            <a href="" class="btn btn-outline-danger mt-2 mx-2">Download</a>
                        </div>
                    </div>
                </div>
                @endforeach
